...
class lpLastVideoWidget {
	 ...
	 */
	function lpLastVideoWidget($category, $width = 255, $height = 175) {
	...
	function _get_video_embed() {
		...
		<div style="text-align: right;"><a href="http://loispereiro.blogaliza.org/category/audiovisual/">m&aacute;is</a></div>
